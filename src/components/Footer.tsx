      ...
      <div className="mx-auto max-w-[1100px]">
        <div className="flex flex-col gap-8 sm:flex-row sm:items-start sm:justify-between">
          ...
          <div className="flex flex-col items-center gap-2 sm:items-start">
            ...
            <div className="flex flex-col gap-2">
              <a
                ...
                className="flex items-center gap-1.5 text-[12px] text-[#dedede]/40 transition-colors hover:text-[#2bf2d1] sm:text-[13px]"
              >
          ...
          <div className="flex items-center justify-center gap-5 sm:gap-6">
            <a href="/mentions-legales" className="text-[12px] text-[#dedede]/30 transition-colors hover:text-[#2bf2d1] sm:text-[13px]">
              Mentions légales
            </a>
            <a href="/confidentialite" className="text-[12px] text-[#dedede]/30 transition-colors hover:text-[#2bf2d1] sm:text-[13px]">
              Confidentialité
            </a>
          </div>
        </div>
