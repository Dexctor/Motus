      ...
      >
        <div className="mx-auto flex max-w-[1200px] items-center justify-between px-5 sm:px-6">
          ...
          <div className="hidden items-center gap-5 sm:flex lg:gap-7">
            <a href="#services" className="text-[14px] text-[#dedede]/70 transition-colors hover:text-[#2bf2d1]">
              Services
            </a>
            ...
            <div className="flex items-center gap-3">
              <MagneticButton>
                <a href="https://www.instagram.com/motus_pocus/" target="_blank" rel="noopener noreferrer" className="flex h-8 w-8 items-center justify-center rounded-full text-[#dedede]/50 transition-colors hover:text-[#2bf2d1]">
              ...
              <MagneticButton>
                <a href="https://www.linkedin.com/in/ga%C3%ABl-dewas-a3156a89/" target="_blank" rel="noopener noreferrer" className="flex h-8 w-8 items-center justify-center rounded-full text-[#dedede]/50 transition-colors hover:text-[#2bf2d1]">
